...
const int chs_delta_rule_sym_count = 6;

const delta_rule chs_delta_rules[] = {
    { "apply_chi_c_rules", "chs.obj", 0, 347, 448, 8, 2 },
    { "apply_chi_h_rules", "chs.obj", 347, 305, 448, 8, 2 },
    { "apply_chi_w_rules", "chs.obj", 652, 269, 448, 8, 2 },
    { "apply_chi_y_rules", "chs.obj", 921, 269, 448, 8, 2 },
};

const int chs_delta_rule_count = 4;
