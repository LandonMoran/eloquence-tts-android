// DecompileLpta: dump C for all apply_*_rules + interpreter helpers of an
// Apple Eloquence lang .so (kor/chs/cht/jpn). Output: /tmp/decomp.txt
// Run headless: analyzeHeadless <proj> <name> -import <lib.so> \
//   -scriptPath <this dir> -postScript DecompileLpta.java -deleteProject
...
public class DecompileLpta extends GhidraScript {
    @Override
